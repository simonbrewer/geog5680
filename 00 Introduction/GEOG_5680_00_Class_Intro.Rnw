...
\title[GEOG 5680/6680 Summer '23]{GEOG 5680 / 6680\\Introduction to R}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item All exercises to be submitted by Friday, June 23
  \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
  	...
  	\end{itemize}
  	\item Due Friday, June 23 through Canvas
  \end{itemize}
\end{itemize}
\end{frame}
