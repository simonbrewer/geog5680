...
\title[GEOG 5680/6680 Summer '24]{GEOG 5680 / 6680\\Introduction to R}
...
\begin{columns}
  \begin{column}{0.5\textwidth}
    Wickham, R for Data Science (O'Reilly)
  	\begin{center}
			\includegraphics[width=0.5\textwidth]{./images/RDS.png}
		\end{center}
	\end{column}
	\begin{column}{0.5\textwidth}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item All exercises to be submitted by Friday, June 21
  \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
  	...
  	\end{itemize}
  	\item Due Friday, June 21 through Canvas
  \end{itemize}
\end{itemize}
\end{frame}
...
%Why R?
\begin{itemize}
	\item At heart, it’s a programming language designed for the analysis of data
	\item Free, open source! 
	\item Large number of existing functions/packages 
	\begin{itemize}
    \item APIs to many services
	  \item Ability to write personal functions 
	\end{itemize}
	\item Extensive graphics capability and extensions
	\item Works well with spatial data
	\begin{itemize}
	...
	\item Increasingly used in many disciplines and industry
\end{itemize}
\end{frame}
