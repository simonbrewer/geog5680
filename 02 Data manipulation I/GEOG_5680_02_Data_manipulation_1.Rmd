...
- Find the row containing maximum number of deaths for 2005 using the `which()` function
- Use this (the row number) to identify the country with the maximum number of deaths in 2005, using R's indexing notation (`[row, col]`)
- Use the same method to find the maximum number of deaths in 2007
