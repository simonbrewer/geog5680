---
title: "GEOG 5680 6680 07 Better plotting with ggplot2"
author: | 
  | Simon Brewer
...
R contains many functions for plotting and visualizing data, including many that are available in add-on packages (e.g. the **rpart.plot** package) that greatly extend the basic functionality. We have looked so far at examples of plotting bivariate data through scatterplots and boxplots. 
