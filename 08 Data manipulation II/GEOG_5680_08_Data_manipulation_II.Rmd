...
Remeber that you can also use R Markdown and **knitr** to produce an html page that contains both the code *and* the plots. If you have the time to do this, I would highly recommend it, as it is a great way to keep all your results in one place.
