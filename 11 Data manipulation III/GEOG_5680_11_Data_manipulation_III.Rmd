...
Note that we can also use the pipe operator (`%>%`) that we used with **dplyr** to pass the selected data to **ggplot2** or any other function. Here, we select calculate the depature delay for all flights to Dallas Fort Worth. Note that we need to load the **magrittr** package to make this work. 
```{r}
library(magrittr)
flights[dest == "DFW",
