...
We can convert this to the more commonly used (and UK-centric :) ) -180 to 180 by the function `rotate()`:
...
air_temp_stk <- stack("./air.mon.ltm.nc", varname = "air")
