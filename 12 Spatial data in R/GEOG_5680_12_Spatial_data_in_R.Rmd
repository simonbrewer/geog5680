...
utah <- st_read(dsn = "./utahcounty/utahcounty.shp",
                layer = "utahcounty",
...
utah <- st_read("./utahcounty/utahcounty.shp")
...
lightrail <- st_read("./LightRail_UTA/LightRail_UTA.shp")

stations <- st_read("./LightRailStations_UTA/LightRailStations_UTA.shp")
